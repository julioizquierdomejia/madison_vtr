...
<head>
    ...
    <link rel="apple-touch-icon" sizes="36x36" href="/online/img/favicon.png">
    <link rel="icon" type="image/png" href="/online/img/favicon.png">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="">
    <meta name="author" content="">

    <title>{{isset($title) ? $title . ' | ' : ''}} Rituales</title>
